    ...
    <MailBoxLayout inbox="Not Selected">
      <div class="flex-1 flex items-center justify-center">
        <div class="text-center">
          ...
          <h3 class="text-xl font-semibold text-white mb-2">Welcome to Mailbox</h3>
          <p class="text-muted-foreground mb-4">Select an account and folder to view your emails</p>
