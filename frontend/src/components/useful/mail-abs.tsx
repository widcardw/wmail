...
const MailAbstract: Component<{ email: Email; selected: boolean; onClick: (v: any) => void }> = (props) => {
  return (
    <div
    ...
    >
      <div class="flex justify-between items-center">
        <span class="font-700 truncate">
          {getEmailSender(props.email.from)}
        </span>
        <span class="text-sm text-mut-foreground">
